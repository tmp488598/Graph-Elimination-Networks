...
class NodeFormer(nn.Module):
    ...
    '''
    def __init__(self, in_channels, hidden_channels, out_channels, num_layers=2, num_heads=1, dropout=0.0,
                 kernel_transformation=softmax_kernel_transformation, nb_random_features=30, use_bn=True, use_gumbel=True,
                 use_residual=True, use_act=False, use_jk=True, nb_gumbel_sample=1, rb_order=0, rb_trans='sigmoid', use_edge_loss=True):
