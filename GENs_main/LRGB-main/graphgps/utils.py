...
def save_result(results):
    if not os.path.exists(f'results/{cfg.dataset.name}'):
        os.makedirs(f'results/{cfg.dataset.name}')

    filename = f'results/{cfg.dataset.name}/{cfg.model.type}_{cfg.gnn.layer_type}.csv'
    print(f"Saving results to {filename}")
    with open(f"{filename}", 'a+') as write_obj:
            write_obj.write( f"{cfg.gnn.layer_type} " + f"{cfg.train.batch_size} " +\
                f"{cfg.gnn.head} " + f"{cfg.optim.base_lr} " + f"{cfg.optim.weight_decay} " + f"{cfg.optim.max_epoch} " + f"{cfg.optim.num_warmup_epochs} " +\
                f"{cfg.gnn.dropout} " + f"{cfg.gnn.residual} " + f"{cfg.gnn.batchnorm} " + f"{cfg.gnn.gens.K} "+\
                f"{cfg.gnn.gens.gamma} "  + f"{cfg.gnn.gens.fea_drop} " + f"{cfg.gnn.gens.base_model} " + f"{cfg.gnn.gens.heads} " + f"{cfg.gnn.gens.hop_att} " +\
                f"{cfg.gnn.gens.use_ffN} " + f"{cfg.gnn.gens.norm_type} " + \
                str(results) +"\n")