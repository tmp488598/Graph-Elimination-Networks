...
from .transforms import RandomWalkSampler,Preprocessor
...
if __name__ == '__main__':
    ...
    from transforms import RandomWalkSampler, Preprocessor
    # preprocessor = Preprocessor("PascalVOC-SP")
    transform = RandomWalkSampler()
    # transform = Compose([preprocessor, transform])
    dataset = VOCSuperpixels('datasets',transform=transform, split='val')
