...
def parse_method(args, n, c, d, device):
    model = MPNNs(d, args.hidden_channels, c, local_layers=args.local_layers, dropout=args.dropout,
                  ...
                  bn=args.bn, jk=args.jk, gnn=args.gnn, args=args).to(device)
...
def parser_add_main_args(parser):
    ...
    parser.add_argument('--hop_att', type=bool, default=True)
    parser.add_argument('--fea_drop', type=str, default='normal')
